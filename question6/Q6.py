...
plt.scatter(exampletable.annualrevenue.x, exampletable.numberofemployees.x, exampletable.y)

plt.title("The relationship between the size of the stores, number of employees and revenue")
plt.ylabel('storesize_ft')
plt.xlabel('numberofemployees')('annualrevenue')
